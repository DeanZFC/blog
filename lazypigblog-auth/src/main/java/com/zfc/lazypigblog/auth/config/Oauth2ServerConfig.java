...
import com.zfc.lazypigblog.auth.component.JwtTokenEnhancer;
import com.zfc.lazypigblog.auth.service.impl.UserServiceImpl;
...
public class Oauth2ServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    /**
     * 配置客户端详情信息，客服端详情信息在这里初始化
     * 可以把客户端详情写死在这，也可以从数据库获取
     * @param clients
     * @throws Exception
     */
    @Override
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory() //存储在缓存中
                .withClient("blog-web") //配置client_id
    ...
    /**
     * 配置令牌（token）的访问端点（url）和令牌服务器（token services）
     * @param endpoints
     * @throws Exception
     */
    @Override
